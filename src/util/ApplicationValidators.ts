// src/util/ApplicationValidators -----------------------------------------------------
 ...
 * value is valid, while "false" means it is not.  If a field is required,
...
/**
 * Validate that the specified Library scope value has a valid format.
 *
 * @param scope                         Proposed scope value
 */
...
/**
 * Validate that the specified Volume location value has a valid value.
 *
 * @param location                      Proposed volume value
 */
...
/**
 * Validate that the specified Volume type value has a valid value.
 *
 * @param type                          Proposed volume type
 */
